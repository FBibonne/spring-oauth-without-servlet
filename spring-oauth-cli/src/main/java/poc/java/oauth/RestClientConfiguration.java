...
public class RestClientConfiguration {
    ...
    @Bean
    public RestClient.Builder restClientBuilder(OAuth2ClientHttpRequestInterceptor oAuth2ClientHttpRequestInterceptor, @Value("${poc.java.oauth.restclient.registration.id}")String registrationId) {
